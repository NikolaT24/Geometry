...
В двумерната евклидова равнина въвеждаме релацията $x \sim y \Leftrightarrow \exists \lambda \in \mathbb{R} \setminus \{0\} : x = \lambda y$ (която лесно се установява, че е релация на еквивалентност), която дефинира структурата на хомогенните координати:
