...
В $𝔼_2$ въвеждаме релацията $x \sim y \Leftrightarrow \exists \lambda \in \mathbb{R} \setminus \lbrace 0 \rbrace : x = \lambda y$ (която лесно се установява, че е релация на еквивалентност), която дефинира структурата на хомогенните координати:
