...
*Първи случай:* Нека $S\in\alpha$. Имаме, че $$\forall M\in\alpha\backslash\lbrace S\rbrace:\psi\_\pi^S(M):=MS\cap\pi\in\alpha\cap\pi$$

*Втори случай:* Нека $\alpha\equiv\pi$. Тогава $\alpha\cap\pi=\alpha$ и значи $\psi\_\pi^S:\alpha\to\alpha=\alpha\cap\pi$, с което сме готови.
</details>
