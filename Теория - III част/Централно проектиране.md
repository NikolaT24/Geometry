...
*Теорема 8:* Спрямо проективна координатна система $K^\star=E_0E_1E_2E_3E_4$ в $\mathbb{E}\_3^{\star}$ са дадени равнина $\pi$ и безкрайна точка $U\not\in\pi$. Нека $$\psi\_\pi^U:\mathbb{E}\_3^{\star}\backslash\lbrace U\rbrace\to\pi$$ е успоредно проектиране. Нека $g$ е права, за която $\psi_\beta^U(g) \neq g \cap \pi$. Тогава

$$
\lbrace\forall g'| g' 
\overset{\circ}{\parallel} \psi_\pi^U(g)\rbrace=\psi_\pi^U(U_g)
$$
