...
*Теорема 6:* Спрямо проективна координатна система $K^\star=E_0E_1E_2E_3E_4$ в $\mathbb{E}\_3^{\star}$ е дадена равнина $\pi\[A,B,C,D\]$ и ортогонално проектиране $$\psi\_\pi^S:\mathbb{E}\_3^{\star}\rbrace\to\pi$$. Тогава проекционният център на даденото ортогонално проектиране е $U(A,B,C,0)$.
