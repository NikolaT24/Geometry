...
$$\psi\_\pi^S:\mathbb{E}\_2^{\star}\backslash\lbrace S\rbrace\to g^\star$$ като $$\forall M\in\mathbb{E}\_2^{\star}\backslash\lbrace S\rbrace:\psi\_{g^\star}^S(M):=MS\cap g^\star$$
