...
*Теорема на Полке-Шварц:* За всеки равнинен четириъгълник $T'\in\pi$ и всеки тетраедър $T$ съществува успоредно проектиране $\psi_\pi^U:\mathbb{E}ѝ_3^\star\backslash\lbrace U\rbrace\to\pi$, такова че $\psi_\pi^U(T)=T^\star\sim T'$, където $\sim$ е релацията афинна-еквивалентност. 
