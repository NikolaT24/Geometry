...
*Теорема на Полке-Шварц:* За всеки равнинен четириъгълник $T'\in\pi$ и всеки тетраедър $T$ съществува успоредно проектиране $\psi_\pi^U:\mathbb{E}_3^\star\backslash\{U\}\to\pi$, такова че $\psi_\pi^U(T)=T^\star\sim T'$ (четириъгълниците $T^\star$ и $T'$ са афинно-еквивалентни. 
