## Централно проектиране на $\mathbb{E}_2^\star$

*Дефиниция:* Централно (перспективно) проектиране на разширената евклидова равнина с проекционна права $g^\star$ и проекционен център $S\not\in g^\star$ наричаме изображението 
$$\psi\_{g^\star}^S:\mathbb{E}\_2^{\star}\backslash\lbrace S\rbrace\to g^\star$$ като $$\forall M\in\mathbb{E}\_2^{\star}\backslash\lbrace S\rbrace:\psi\_{g^\star}^S(M):=MS\cap g^\star$$
