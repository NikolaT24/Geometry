# Централно проектиране на $\mathbb{E}_3^\star$
...
Нека $g$ е произволна права, различна от правата, задаваща проектиращото направление на $\psi\_\pi^U$. Нека $U_g$ е безкрайната точка на $g$ и $$\psi\_\pi^U:g\to g^\star=\psi\_\pi^U(g)$$ Тогава, предвид това, че $g^\star$ е инцидентна с проекционната равнина $\pi$ имаме $$\psi\_\pi^U(U_g)=U_{g^\star}\in u_{\pi}$$ Така показахме, че произволна точка $U_g\in \Omega\backslash\lbrace U\rbrace$ се проектира в безкрайната права на $\pi$, значи $$\psi\_\pi^U:\Omega\backslash\lbrace U\rbrace\to u_{\pi}$$
</details>

*Теорема 8:* Нека матрицата $C\in M_4(\mathbb{R})$ задава линейна трансформация $\psi$ в $\mathbb{E}\_3^\star$. Тогава $\psi$ е централно проектиране, ако $C^2=\sigma C$, където $\sigma$ е ненулев коефициент на пропорционалност.
