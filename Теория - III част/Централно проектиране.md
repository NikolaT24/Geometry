...
Нека $g$ е произволна права, различна от правата, задаваща проектиращото направление на $\psi\_\pi^U$. Нека $U_g$ е безкрайната точка на $g$ и $$\psi\_\pi^U:g\to g^\star=\psi\_\pi^U(g)$$ Тогава, предвид това, че $g^\star$ е инцидентна с проекционната равнина $\pi$ имаме $$\psi\_\pi^U(U_g)=U_{g^\star}\in u_{\pi}$$
</details>
